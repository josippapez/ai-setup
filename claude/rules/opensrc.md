---
description: Use opensrc to read library source code before assuming internals, debugging library behaviour, or verifying an API exists in the installed version. Invoke the opensrc skill for full usage.
---
