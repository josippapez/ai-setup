...
- Ground in the repo's existing CI/deploy conventions (via the bundled repo-docs MCP and existing workflow files) before changing them; match the established structure.
