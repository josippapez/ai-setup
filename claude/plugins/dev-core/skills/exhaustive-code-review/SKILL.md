...
Six lanes, dispatched **in a single message so they run at once**, each over the **whole**
...
Where the harness offers `ReportFindings`, report through it; the ledger stays the source
of truth for what was covered.
