...
- `rules/concise-output.instruction.md` — how long. Lead with the result, one to three
  sentences, detail and explanation opt-in. Covers chat, code comments, commits, PR and
  issue text, docs, and logs. Agent-to-agent traffic is exempt.
