...
description: 'Write short, human review comments for anything posted to other people: PR review comments and replies, PR descriptions, and Azure DevOps, GitHub, or Jira work-item and issue comments.'
when_to_use: 'Triggers: "leave inline comments", "draft review comments", "post review comments", "reply on that thread", "comment on the ticket", "comment on the work item", "update the ADO comment", "make it short", "human like", "PR comments", "review this PR". Use whenever text is about to be posted where other people will read it, especially when the user asks for concise or human-sounding comments.'
---
