...
- Linear is the source of truth; on resume, read the parent's **Progress / Resume here** comment for the fast path, then re-read open sub-issues to rebuild state (sub-issue statuses remain authoritative).
