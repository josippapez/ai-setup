...
milestone** and its **chunks as issues** (and, for a UI epic, a read-only `design-lead` produces an
accessible, WCAG 2.2 A/AA design direction before decomposing), then dispatches **self-managing** `linear-worker`
