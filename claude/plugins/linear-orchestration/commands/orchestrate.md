...
The skill is the source of truth for the full workflow (gate → intake/grill → explore/scout → refine/council → decompose → execute → relay/record → converge), status map, and invariants. Follow it exactly.
