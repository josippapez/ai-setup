...
Invoke the `orchestrate-nightly:orchestrate-nightly` skill and follow it as the orchestrator and prompt-loop owner.
...
The skill is the source of truth for the full workflow. Follow it exactly; do not fall back to the stable `orchestrate` skill mid-epic.
