...
when_to_use: 'Only on explicit request: the user says "nightly", "orchestrate nightly", "use the nightly orchestration", or runs /orchestrate-nightly, or resumes an epic whose EPIC.md records `workflow: nightly`. Never engage on the generic "track this" / "orchestrate this" triggers; those belong to the stable orchestrate skill.'
---
