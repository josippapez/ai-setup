...
- `writing-code` rule card — the hunk-level half of this bar
- `evidence-first` — observed case; `writing-code` — YAGNI, surgical changes, root cause
