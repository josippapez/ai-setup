...
- Ground first: use the repo-docs MCP (`find_docs`/`read_doc`) and read neighboring components before writing. Reuse existing shared components, design tokens, and theme primitives over new bespoke ones or hardcoded values.
