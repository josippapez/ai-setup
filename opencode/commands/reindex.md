...
!`ROOT="$(git rev-parse --show-toplevel 2>/dev/null || pwd)"; CONFIG="${XDG_CONFIG_HOME:-$HOME/.config}/opencode"; NODE_PATH="$CONFIG/node_modules" node "$CONFIG/plugins/interactive-mcp/tools/build-semantic-index.cjs" "$ROOT"`
